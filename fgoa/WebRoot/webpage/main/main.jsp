...
<html>
<head>
<title>武汉市房地产市场管理中心——协同办公系统</title>
...
<!-- 顶部-->
<div region="north" border="false" title="武汉市房地产市场管理中心——协同办公系统" style="height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/logo.png;"> <img src="plug-in/login/images/foot.png"></td>
