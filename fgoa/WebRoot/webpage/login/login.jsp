...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><img src="plug-in/login/images/logo.png" /><img src="plug-in/login/images/foot.png" /></div>
            <div class="formLogin">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><%-- <a href="#" title="JEECG 微云快速开发平台">jeecg</a>--%> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)</span></div>
    </div>
    <!-- Link JScript-->
