...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="houseAssetsController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						  	 	<textarea id="address" name="address">${houseAssetsPage.address}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="buildingArea" name="buildingArea" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${houseAssetsPage.buildingArea}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="landArea" name="landArea" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${houseAssetsPage.landArea}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="contractPrice" name="contractPrice" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${houseAssetsPage.contractPrice}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="achieveTime" name="achieveTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${houseAssetsPage.achieveTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="certificateTime" name="certificateTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${houseAssetsPage.certificateTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						  	 	<textarea id="purpose" name="purpose">${houseAssetsPage.purpose}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="ownership" name="ownership">${houseAssetsPage.ownership}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						  	 	<textarea id="housingSituation" name="housingSituation">${houseAssetsPage.housingSituation}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="leaseTime" name="leaseTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${houseAssetsPage.leaseTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="userPhone" name="userPhone" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${houseAssetsPage.userPhone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="other" name="other">${houseAssetsPage.other}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						  	 	<textarea id="remark" name="remark">${houseAssetsPage.remark}</textarea>
							<span class="Validform_checktip"></span>
