...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="examInfoController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<%--<td class="value">
						     	 <input id="content" name="content" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${examInfoPage.content}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">内容</label>
						</td>--%>
										
						<td class="value"><t:ckeditor name="content" isfinder="true"
						value="${examInfoPage.content}" type="width:850,height:300"></t:ckeditor>
