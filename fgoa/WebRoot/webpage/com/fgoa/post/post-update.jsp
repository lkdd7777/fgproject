...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="postController.do?doUpdate" tiptype="1">
						...
						<td class="value">
									  <input id="submittime" name="submittime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${postPage.submittime}' type="date" pattern="yyyy-MM-dd"/>'>    
