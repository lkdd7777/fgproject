...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="deviceManageController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="myorder" name="myorder" type="text" style="width: 200px" class="inputxt"  
									                 ...
									                 value='${deviceManagePage.myorder}'>
					...
					<tr>
						...
						<td class="value">
								 <t:dictSelect field="type" type="list" id="type"  defaultVal='${deviceManagePage.type}'
					...
					<tr>
						...
						<td class="value">
						     	 <input id="devicetype" name="devicetype" type="text" style="width: 200px" class="inputxt"  
									                 ...
									                 value='${deviceManagePage.devicetype}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="purchasedate" name="purchasedate" type="text" style="width: 200px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${deviceManagePage.purchasedate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="baseconfig" name="baseconfig" type="text" style="width: 200px" class="inputxt"  
									                 ...
									                 value='${deviceManagePage.baseconfig}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							 <t:dictSelect field="status" type="list" id="status" defaultVal='${deviceManagePage.status}'
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remark" style="width: 400px" name="remark">${deviceManagePage.remark}</textarea>
							<span class="Validform_checktip"></span>
