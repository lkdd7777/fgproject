...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="examPaperController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="starttime" name="starttime" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${examPaperPage.starttime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
					...
					<tr>
						...
						<td class="value">
									  <input id="endtime" name="endtime" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${examPaperPage.endtime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="pausetime" name="pausetime" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${examPaperPage.pausetime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="iscomplete" name="iscomplete" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${examPaperPage.iscomplete}'>
							<span class="Validform_checktip"></span>
