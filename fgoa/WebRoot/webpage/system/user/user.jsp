...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
     ...
     ${user.userName }
				...
				<span class="Validform_checktip">用户名范围在2~20位字符</span>
			</c:if></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value">
				<input class="inputxt" name="mobilePhone" value="${user.mobilePhone}" errormsg="手机号码不正确!" ignore="ignore">
				<input type="checkbox" name="showMobile" <c:if test="${user.showMobile==true}">checked</c:if>>在前台显示
				<span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label"> 办公电话: </label></td>
			<td class="value"><input class="inputxt" name="officePhone" value="${user.officePhone}" errormsg="办公室电话不正确!" ignore="ignore"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right"><label class="Validform_label"> 门号: </label></td>
			<td class="value"><input class="inputxt" name="officno" value="${user.officno}" errormsg="邮箱格式不正确!"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label"> 排序: </label></td>
			<td class="value"><input class="inputxt" name="orderNum" value="${user.orderNum}"> <span class="Validform_checktip"></span></td>
		</tr>
	</table>
</t:formvalid>
</body>