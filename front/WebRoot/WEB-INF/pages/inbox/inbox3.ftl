	...
	$(function(e) {
		...
		$("#inboxInfoForm").submit(function(){
		 ...
		 $("#uploadify").uploadify({
            ...
            //后台处理的页面
            'uploader': '${base}/file/uploadFile?id=${subFileFolder}&type=2',
            //按钮显示的文字
            'buttonText': '上传附件',
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg">
			...
			<form id="inboxInfoForm" action="${base}/inbox/saveProcessInfo" method="post">
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						<th style="width:132px;">来文单位</th>
						<td style="width:300px;">
							<textarea class="require" name="orgName">${orgName!}</textarea>
						</td>
						<th style="width:132px;">来文日期<br>(格式:2014-08-05)</th>
						<td style="width:300px;">
					...
					<tr>
						<th>来文字号</th>
						<td>
							<textarea name="tag">${tag!}</textarea>
						</td>
						<th>收文编号</th>
						<td>
					...
					<tr>
						...
						<th>密级</th>
						<td>
							<textarea name="classification">${classification!}</textarea>
						</td>
					</tr>
				</table>
