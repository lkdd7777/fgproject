...
#main .link{background:url(${base}/res/images/Inbox/Inbox2_1.jpg) no-repeat;width:416px;height:63px;overflow:hidden;margin:0 auto; position:relative;}
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg">
			<div class="link">
				<a class="left" href="${base}/inbox/handleDoc?subFileFolder=${subFileFolder}">点击处理文件</a>
				<a class="right" href="#">点击提交</a>
			</div>
		</div>
	</div>
