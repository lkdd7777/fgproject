...
#main .list_box ul li{height:46px;overflow:hidden;line-height:46px;font-size:16px;border-bottom:1px solid #dfdfdf;cursor:pointer;background:url(${base}/res/images/Inbox/Inbox10_2.png) 120px -3px no-repeat;text-align:center;}
#main .list_box ul li.selected{background:url(${base}/res/images/Inbox/Inbox10_2.png) 120px -57px no-repeat #f5f5f5;}
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg">
			...
			<div class="btn">
				<form action="${base}/inbox/saveLeaderInfo" method="post">
