...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg">
			...
			<div class="btn">
				<a style="margin-right:35px;"><img src="${base}/res/images/Posting/Posting2-01.jpg" alt="" /></a>
				<a><img src="${base}/res/images/Posting/Posting2-02.jpg" alt="" /></a>
			</div>
		</div>
	</div>
