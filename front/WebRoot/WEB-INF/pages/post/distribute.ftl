...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg clearfix">
					...
					<div class="ul_box">
						<ul>
							<#list departs as item>
								<li class='orglist' data-rel='${item.ID}'>${item.departname}</li>
							</#list>
						</ul>
					</div>
					<div class="select_All">全选</div>
			...
			<div class="btn">
				<form action="${base}/post/saveChooseOrg" method="post">
					<div id="hiddenValues"></div>
					<input type="hidden" value="${postInfoId}" name="postInfoId"/>
					<a class="cancel" href="${base}/post/managerPostList" title="取消"><img src="${base}/res/images/Inbox/Inbox5_4.jpg" /></a>
