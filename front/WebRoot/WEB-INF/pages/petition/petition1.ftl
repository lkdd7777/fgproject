...
#main input.click{display:block;background:url(${base}/res/images/Petition/Inbox1_2.jpg) no-repeat;width:246px;overflow:hidden;height:63px;padding:0px;border:0px;cursor:pointer;float:left;}
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="submit">
			<form action="${base}/petition/uploadFiles" enctype="multipart/form-data" method="post">
