...
#main .bg{background:url(${base}/res/images/Petition/Inbox10_1.jpg) 68px 65px no-repeat #fff;padding:65px 0 120px 319px;}
...
#main .list_box ul li.selected{background:url(${base}/res/images/Inbox/Inbox5_2.jpg) 180px 11px no-repeat;}
#main .list_box .bottom_btn{height:56px;background:url(${base}/res/images/Inbox/Inbox5_3.jpg) top center no-repeat #f5f5f5;cursor:pointer;border-bottom:1px solid #dfdfdf;}
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg clearfix">
			<div class="clearfix">
				<#if (viceDirector ??) && (viceDirector?size>0) > 
			...
			<div class="btn">
				<form action="${base}/petition/saveChooseUsers" method="post">
					<div id="hiddenValues"></div>
					<input type="hidden" value="${petitionInfoId}" name="petitionInfoId"/>
