...
#main .leader_msg .msg{border-bottom:1px dotted #bbb;padding:5px 12px;margin-bottom:10px;}
...
<div id="wrap">
	...
	<div id="main">
		...
		<div class="bg">
			...
			<form action="${base}/petition/saveRemark" method="post">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th style="width:116px;">来件标题</th>
						<td style="width:316px;">${info.title}</td>
						<th style="width:116px;">来件渠道</th>
						<td style="width:316px;">网站信访中心</td>
					</tr>
					<tr>
						<th style="width:116px;">来件单位</th>
						<td style="width:316px;">${info.orgName}</td>
						<th style="width:116px;">来件日期</th>
